...
ControlesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ControlesComponent, selectors: [["app-controles"]], inputs: { doorAssets: "doorAssets", doorName: "doorName" }, decls: 10, vars: 12, consts: [[1, "controles-wrapper", 3, "ngClass"], ["class", "controle-row", 4, "ngIf"], [1, "controle-row"], [1, "row-title"], [1, "preview-items"], ["cdkDropList", "", 4, "ngFor", "ngForOf"], ["cdkDropList", ""], ["cdkDrag", "", 1, "preview-item", "frame-item", 3, "ngStyle"], [1, "item-name"], ["cdkDrag", "", 1, "preview-item", "board-item", 3, "ngStyle"], [4, "ngIf"], ["cdkDrag", "", 1, "preview-item", "bevel-item", 3, "ngStyle"], [1, "preview-items", "short-handles"], ["cdkDrag", "", 1, "preview-item", "handle-item", "short-handle-item", 3, "ngStyle"], [1, "preview-items", "long-handles"], ["cdkDrag", "", 1, "preview-item", "handle-item", "long-handle-item", 3, "ngStyle"], [1, "preview-items", "dividers"], ["class", "preview-item divider-item", 3, "ngStyle", "click", 4, "ngFor", "ngForOf"], [1, "preview-item", "divider-item", 3, "ngStyle", "click"]], template: function ControlesComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx.doorAssets.crosswise == null ? null : ctx.doorAssets.crosswise.length);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx.doorAssets["45-degree"] == null ? null : ctx.doorAssets["45-degree"].length);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
...
ModernModelCComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: ModernModelCComponent, selectors: [["app-modern-model-c"]], inputs: { assets: "assets" }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵInheritDefinitionFeature"]], decls: 13, vars: 39, consts: [[1, "door"], ["cdkDropList", "", 1, "area", "frame", 3, "ngStyle", "cdkDropListDropped", "cdkDropListEntered", "cdkDropListExited"], [1, "shadow"], ["cdkDropList", "", 1, "area", "board", "piece-1", 3, "ngStyle", "cdkDropListDropped", "cdkDropListEntered", "cdkDropListExited"], ["cdkDropList", "", 1, "area", "board", "piece-2", 3, "ngStyle", "cdkDropListDropped", "cdkDropListEntered", "cdkDropListExited"], ["cdkDropList", "", 1, "area", "board", "piece-3", 3, "ngStyle", "cdkDropListDropped", "cdkDropListEntered", "cdkDropListExited"], ["cdkDropList", "", 1, "area", "board", "piece-4", 3, "ngStyle", "cdkDropListDropped", "cdkDropListEntered", "cdkDropListExited"], ["cdkDropList", "", 1, "area", "handle", "short-handle", 3, "ngStyle", "ngClass", "cdkDropListDropped", "cdkDropListEntered", "cdkDropListExited"], ["shortHandle", ""], [1, "divider", "divider-1", 3, "ngStyle", "ngClass"], [1, "divider", "divider-2", 3, "ngStyle", "ngClass"], [1, "divider", "divider-3", 3, "ngStyle", "ngClass"]], template: function ModernModelCComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngStyle", _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpureFunction1"](21, _c0, "url(" + (ctx.assets.lengthwise[8] == null ? null : ctx.assets.lengthwise[8].url) + ")"));
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](1);
    ...
    } }, directives: [_angular_cdk_drag_drop__WEBPACK_IMPORTED_MODULE_3__["CdkDropList"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["NgStyle"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["NgClass"]], styles: [".piece-1[_ngcontent-%COMP%] {\n  top: 26px;\n  -webkit-clip-path: polygon(0 0, 100% 0, 100% 100%, 0 60%);\n          clip-path: polygon(0 0, 100% 0, 100% 100%, 0 60%);\n  height: 554px;\n  position: absolute;\n  left: 26px;\n  width: 235px;\n  z-index: 2;\n}\n\n.piece-2[_ngcontent-%COMP%] {\n  bottom: -146px;\n  -webkit-clip-path: polygon(0 0, 100% 50%, 100% 100%, 0 100%);\n          clip-path: polygon(0 0, 100% 50%, 100% 100%, 0 100%);\n  height: 365px;\n  position: absolute;\n  left: 26px;\n  width: 235px;\n  z-index: 5;\n}\n\n.piece-3[_ngcontent-%COMP%] {\n  background-position: center;\n  -webkit-clip-path: polygon(0 0, 100% 25%, 100% 100%, 0 72%);\n          clip-path: polygon(0 0, 100% 25%, 100% 100%, 0 72%);\n  height: 440px;\n  left: 113px;\n  position: absolute;\n  top: 120px;\n  width: 148px;\n  z-index: 2;\n}\n\n.piece-4[_ngcontent-%COMP%] {\n  top: 35px;\n  height: 575px;\n  left: 35px;\n  position: absolute;\n  width: 242px;\n  z-index: 1;\n}\n\n.divider-1[_ngcontent-%COMP%] {\n  top: 26px;\n  height: 400px;\n  left: 110px;\n  position: absolute;\n  width: 3px;\n  z-index: 5;\n}\n\n.divider-2[_ngcontent-%COMP%] {\n  height: 186px;\n  left: 185px;\n  position: absolute;\n  top: 80px;\n  transform: rotate(-53.3deg);\n  width: 3px;\n  z-index: 6;\n}\n\n.divider-3[_ngcontent-%COMP%] {\n  height: 298px;\n  left: 142px;\n  position: absolute;\n  top: 304px;\n  transform: rotate(-52deg);\n  width: 3px;\n  z-index: 6;\n}\n\n@media (max-width: 500px) {\n  .piece-1[_ngcontent-%COMP%] {\n    height: 382px;\n    right: 18px;\n    width: 106px;\n  }\n\n  .piece-2[_ngcontent-%COMP%] {\n    left: 18px;\n    height: 382px;\n    width: 65px;\n  }\n\n  .divider-1[_ngcontent-%COMP%] {\n    left: 83px;\n    height: 382px;\n    width: 2px;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
ClassicModelAComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: ClassicModelAComponent, selectors: [["app-classic-model-a"]], inputs: { assets: "assets" }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵInheritDefinitionFeature"]], decls: 8, vars: 12, consts: [[1, "door"], [1, "edges", "edge-1"], [1, "edges", "edge-2"], [1, "edges", "edge-3"], ["cdkDropList", "", 1, "area", "board", "piece-1", 3, "ngStyle", "cdkDropListDropped", "cdkDropListEntered", "cdkDropListExited"], ["cdkDropList", "", 1, "area", "bevel", 3, "ngStyle", "cdkDropListDropped", "cdkDropListEntered", "cdkDropListExited"], ["cdkDropList", "", 1, "area", "handle", "short-handle", 3, "ngStyle", "ngClass", "cdkDropListDropped", "cdkDropListEntered", "cdkDropListExited"], ["shortHandle", ""]], template: function ClassicModelAComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](1, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](2, "div", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](3, "div", 3);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](4, "div", 4);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("cdkDropListDropped", function ClassicModelAComponent_Template_div_cdkDropListDropped_4_listener($event) { return ctx.onDroped($event); })("cdkDropListEntered", function ClassicModelAComponent_Template_div_cdkDropListEntered_4_listener($event) { return ctx.onEntered($event); })("cdkDropListExited", function ClassicModelAComponent_Template_div_cdkDropListExited_4_listener($event) { return ctx.onExit($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](5, "div", 5);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngStyle", _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpureFunction1"](4, _c0, "url(" + (ctx.assets.lengthwise[0] == null ? null : ctx.assets.lengthwise[0].url) + ")"));
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngStyle", _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpureFunction1"](6, _c0, "url(" + (ctx.assets["classic-bevels"][0] == null ? null : ctx.assets["classic-bevels"][0].url) + ")"));
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngStyle", _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpureFunction1"](8, _c0, "url(" + (ctx.assets["short-handles"][0] == null ? null : ctx.assets["short-handles"][0].url) + ")"))("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpureFunction1"](10, _c1, ctx.editorService.isEditing));
    } }, directives: [_angular_cdk_drag_drop__WEBPACK_IMPORTED_MODULE_3__["CdkDropList"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["NgStyle"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["NgClass"]], styles: [".piece-1[_ngcontent-%COMP%] {\n  height: 580px;\n  overflow: hidden;\n  width: 286px;\n  z-index: 1;\n}\n\n.edges[_ngcontent-%COMP%] {\n  background: #0000003d;\n  bottom: 0;\n  height: 554px;\n  position: absolute;\n  width: 1px;\n  z-index: 2;\n  box-shadow: 0px 0px 4px 2px #00000038;\n}\n\n.edges.edge-1[_ngcontent-%COMP%] {\n  left: 26px;\n}\n\n.edges.edge-2[_ngcontent-%COMP%] {\n  right: 26px;\n}\n\n.edges.edge-3[_ngcontent-%COMP%] {\n  transform: rotate(90deg);\n  right: 142px;\n  top: -89px;\n  height: 230px;\n}\n\n.bevel[_ngcontent-%COMP%] {\n  background-position: right top;\n  bottom: 0;\n  height: 554px;\n  position: absolute;\n  right: 26px;\n  width: 234px;\n  z-index: 4;\n}\n\n.divider-1[_ngcontent-%COMP%] {\n  height: 554px;\n  bottom: 0;\n  left: 108px;\n  position: absolute;\n  width: 3px;\n  z-index: 4;\n}\n\n@media (max-width: 500px) {\n  .piece-1[_ngcontent-%COMP%] {\n    height: 382px;\n    right: 18px;\n    width: 106px;\n  }\n\n  .piece-2[_ngcontent-%COMP%] {\n    left: 18px;\n    height: 382px;\n    width: 65px;\n  }\n\n  .divider-1[_ngcontent-%COMP%] {\n    left: 83px;\n    height: 382px;\n    width: 2px;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
function EditorComponent_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](4);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("assets", ctx_r0.doorAssets)("doorName", ctx_r0.doorName);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](5, _c1, ctx_r0.editorService.isEditing));
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("doorAssets", ctx_r0.doorAssets)("doorName", ctx_r0.doorName);
} }
...
class EditorComponent {
    ...
    ngOnInit() {
        var _a, _b;
        console.log('this.editorService.door: ', this.editorService.door);
    ...
    saveImage() {
        // OLD SAVE
        // htmlToImage.toPng(this.editor.nativeElement)
        // .then((dataUrl) => {
        //   const img = new Image();
        //   img.src = dataUrl;
        //   const a = document.createElement('a'); // Create <a>
...
EditorComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: EditorComponent, selectors: [["app-editor"]], viewQuery: function EditorComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, decls: 3, vars: 2, consts: [["class", "editor", "cdkDropListGroup", "", 4, "ngIf", "ngIfElse"], ["spinner", ""], ["cdkDropListGroup", "", 1, "editor"], [1, "playground"], ["editor", ""], [1, "main-door"], [3, "assets", "doorName"], [1, "controles", 3, "ngClass"], [3, "doorAssets", "doorName"], [1, "spinner"]], template: function EditorComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](0, EditorComponent_div_0_Template, 7, 7, "div", 0);
    ...
    } }, directives: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["NgIf"], _angular_cdk_drag_drop__WEBPACK_IMPORTED_MODULE_5__["CdkDropListGroup"], _door_door_component__WEBPACK_IMPORTED_MODULE_6__["DoorComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["NgClass"], _controles_controles_component__WEBPACK_IMPORTED_MODULE_7__["ControlesComponent"]], styles: [".editor[_ngcontent-%COMP%] {\n  display: flex;\n  margin-left: 70px;\n  width: calc(100% - 70px);\n  height: 100%;\n}\n\n.playground[_ngcontent-%COMP%] {\n  background: #f7f8fa;\n  position: relative;\n  width: 60%;\n  z-index: 0;\n}\n\n.controles[_ngcontent-%COMP%] {\n  width: 40%;\n}\n\n.main-door[_ngcontent-%COMP%] {\n  left: 50%;\n  position: absolute;\n  top: 50%;\n  transform: translate(-50%, -50%);\n  width: 286px;\n}\n\n.button-container[_ngcontent-%COMP%]   button[_ngcontent-%COMP%] {\n  border: none;\n  background: #fecf1f;\n  padding: 8px 36px;\n  border-radius: 4px;\n  font-size: 12px;\n  cursor: pointer;\n  width: 100%;\n}\n\n.button-container[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]:disabled {\n  opacity: 0.5;\n}\n\n.file-name[_ngcontent-%COMP%] {\n  width: 100%;\n  padding: 6px;\n  display: inline-block;\n  box-sizing: border-box;\n  margin-bottom: 6px;\n  border: 1px solid #c9c9c9;\n  border-radius: 4px;\n}\n\n.save-img[_ngcontent-%COMP%] {\n  height: 130px;\n  padding-top: 12px;\n  border-top: 1px solid #dbdbdb;\n}\n\n.save-img[_ngcontent-%COMP%]   .label[_ngcontent-%COMP%] {\n  margin-bottom: 8px;\n}\n\n@media (max-width: 1200px) {\n  .playground[_ngcontent-%COMP%], .controles[_ngcontent-%COMP%] {\n    width: 50%;\n  }\n}\n\n@media (max-width: 500px) {\n  .editor[_ngcontent-%COMP%] {\n    flex-direction: column;\n    position: relative;\n  }\n\n  .playground[_ngcontent-%COMP%], .controles[_ngcontent-%COMP%] {\n    width: 100%;\n  }\n\n  .controles[_ngcontent-%COMP%] {\n    border-left: none;\n    border-top: 1px solid #279cff;\n    height: calc(100vh - 440px);\n  }\n\n  .main-door[_ngcontent-%COMP%] {\n    width: 100%;\n    left: unset;\n    position: relative;\n    top: unset;\n    transform: unset;\n  }\n\n  .preview-items[_ngcontent-%COMP%] {\n    grid-template-columns: repeat(3, 1fr);\n  }\n\n  .preview-item[_ngcontent-%COMP%] {\n    height: 150px;\n  }\n}\n\n.spinner[_ngcontent-%COMP%] {\n  font-size: 18px;\n  left: 50%;\n  position: fixed;\n  top: 50%;\n  transform: translate(-50%, -50%);\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
